...
////// Emissive:
                ...
                float node_9732 = (node_2203*node_7860); // TotalNumFrames
                float node_6473 = (node_9732*(_node_7167/node_9732)); // CurrentFrame
