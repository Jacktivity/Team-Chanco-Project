...
////// Lighting:
////// Emissive:
                float4 node_9814 = _Time;
                float2 node_2203 = (i.uv0+node_9814.g*float2(0,-0.2));
                float4 _node_3837_var = tex2D(_node_3837,TRANSFORM_TEX(node_2203, _node_3837));
                float2 node_9655 = (i.uv0+node_9814.g*float2(0.2,-0.2));
                ...
                float3 emissive = (i.vertexColor.rgb*node_1638);
