...
Shader "Shader Forge/SH_Characters" {
    Properties {
        ...
        _OutlineWidth ("OutlineWidth", Float ) = 0.003
        _Outline ("Outline", Vector) = (1,0,0,1)
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : SV_Target {
                ...
                float4 _Emissive_var = tex2D(_Emissive,TRANSFORM_TEX(i.uv0, _Emissive));
                o.Emission = (_Emissive_var.rgb*_Emissive_Intensity);
